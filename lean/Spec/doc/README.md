...
| [`GoldfishWalk.lean`](../Defs/GoldfishWalk.lean) | what `get_head` takes from the layer — the anchor, the blocks, the eligibility condition; one instance, supplied by the layer whose readings are the protocol's |
