...
| `lem:empty-slot-noop` | Lem. 3 | `lemEmptySlotNoop` — waits on Def. 20 | 4 | 🔨 stated |
| `lem:finalized-before-justified` | Lem. 4 | `lemFinalizedBeforeJustified` — proof outstanding; block post-states only | 3 | 🔨 stated |
| `lem:target-uniqueness` | Lem. 5 | `lemTargetUniqueness` — waits on Defs. 21 and 11 | 6 | 🔨 stated |
| `lem:height-progression` | Lem. 6 | `lemHeightProgression` — proof outstanding; the increment half only | 3 | 🔨 stated |
| `lem:height-target-freshness` | Lem. 7 | `lemHeightTargetFreshness` — proof outstanding | 1 | 🔨 stated |
| `lem:chain-target-uniqueness` | Lem. 8 | `lemChainTargetUniqueness` — proof outstanding; conflicting-branch half only | 6 | 🔨 stated |
| `lem:past-finalized` | Lem. 10 | `lemPastFinalized` — waits on Defs. 21, 11 and 20 | 17 | 🔨 stated |
| `lem:finalized-chain` | Lem. 11 | `lemFinalizedChain` — waits on Def. 21 and Ass. 1's fault bound | 8 | 🔨 stated |
