...
Lemmas 1 to 4** — the first three proved, Lemma 4 written down with its proof outstanding.
...
| `lem:finalized-before-justified` | Lem. 4 | `lemFinalizedBeforeJustified` over a block post-state — the finality-action-state half waits on this one's proof | 3 | 🔨 stated |
