...
Definitions 11 and 21, and Lemmas 1 to 6** — Lemmas 1 to 5 proved, Lemma 6 written down with its
proof outstanding, and each covering its paper sentence in full. Every other Lean cell is `—`. The row set is the paper's, not a plan: a row appearing here says
...
| `lem:height-progression` | Lem. 6 | `lemHeightProgression` — both halves, over a block post-state's transition | 3 | 🔨 stated |
