...
Definitions 11 and 21, and Lemmas 1 to 7**, all proved and each covering its paper sentence in full.
...
| `lem:height-target-freshness` | Lem. 7 | `lemHeightTargetFreshness`; the paper's definite "the post-state at `T`" via `postState_unique`, without Figure 3 | 1 | ✅ proved |
