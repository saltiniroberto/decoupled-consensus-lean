...
sentence in full; Lemma 8 is written down in four statements and none is proved.
...
| `lem:chain-target-uniqueness` | Lem. 8 | `lemChainTargetUniqueness`, `lemChainTargetTransfer`, `lemChainTargetBothBits`, `lemChainTargetConflict` — one per claim; the fourth sentence bounds the scope of the others and is not stated | 6 | 🔨 stated |
