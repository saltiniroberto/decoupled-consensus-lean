...
Definitions 11 and 21, and Lemmas 1 to 5**, each covering its paper sentence in full. Every other
Lean cell is `—`. The row set is the paper's, not a plan: a row appearing here says
