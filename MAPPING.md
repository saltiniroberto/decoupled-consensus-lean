...
11 and 21 except the store-facing `FC`, and Lemmas 1 to 11 with Theorem 5.** Lemmas 1 to 7, 10 and
11 and Theorem 5 are proved; Lemma 8 is five statements with the first proved; Lemma 9's first
sentence is proved and its second stated.
...
| `thm:accountable-safety` | Thm. 5 | `thmAccountableSafety`, in `Analysis/Theorems.lean` — the "unless" as the conclusion, inclusions on the two chains in either order; kernel-clean 2026-08-16 | prose only | ✅ proved |
