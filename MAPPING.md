...
| `lem:empty-slot-noop` | Lem. 3 | `lemEmptySlotNoop` as a record equation, `lemEmptySlotNoopFields` for the paper's list — one gap left, `settled_of_blockPostState` | 4 | 🔨 stated |
